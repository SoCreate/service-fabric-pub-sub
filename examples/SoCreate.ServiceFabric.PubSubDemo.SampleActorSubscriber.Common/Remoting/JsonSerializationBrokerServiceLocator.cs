...
{
    internal class JsonSerializationBrokerServiceLocator : IBrokerServiceLocator
    {
        ...
        /// </summary>
        public JsonSerializationBrokerServiceLocator(Uri brokerServiceUri = null, IHashingHelper hashingHelper = null)
        {
            _hashingHelper = hashingHelper ?? new HashingHelper();
            _fabricClient = new FabricClient();
            _serviceProxyFactory = new ServiceProxyFactory(FabricConfiguration.GetProxyFactories().GetServiceRemotingClientFactory());
